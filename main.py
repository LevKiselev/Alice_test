# Добавляем к навыку Алисы работу с картинками и запрос имени пользователя
...
# Создадим словарь, чтобы для каждой сессии общения с навыком хранились некие данные, например, имя пользователя.
sessionStorage = {}
...
def handle_dialog(req, res):
    ...
    if req['request']['original_utterance'].lower() in [
        ...
        res['response']['text'] = f"{sessionStorage[user_id]['first_name'].title()}, ждем тебя в Туле!"
        res['response']['card'] = {}
